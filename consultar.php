...
// Requerimiento 7: Guardar en la bitácora que se consultó la tabla 'mascotas'
registrarBitacora($pdo, 'consultar registro', "El usuario consultó el listado general de la tabla 'mascotas'");
...
<head>
    ...
    <title>Consultar Mascotas - Sistema de Gestión</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active text-white fw-bold" href="consultar.php">Consultar</a></li>
    ...
    <div class="container my-5">
        ...
        <div class="card shadow-sm border-0">
            <div class="card-header bg-success text-white py-3">
                <h4 class="mb-0 fw-bold"><i class="bi bi-search"></i> Listado General de Mascotas Alojadas</h4>
            </div>
            <div class="card-body p-4">
                            ...
                            <tbody>
                                <?php foreach ($mascotas as $mascota): ?>
                                    <tr>
                                        ...
                                        <td class="text-muted small"><?php echo htmlspecialchars($mascota['descripcion'] ?: 'Sin descripción'); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                ...
                <?php else: ?>
                    <div class="alert alert-info mb-0 text-center" role="alert">
                        ...
                        No hay mascotas registradas actualmente en el refugio.
                    </div>
                <?php endif; ?>
